...
\end{equation}
kann als Funktion der Knotenleistung $S_\mathbf{k}$ dargestellt werden. Der  Ausduck folgt direkt aus der Leistungsdefinition \eqref{eq:power_current}.
Bei Bildung von der Stromänderung wird beachtet, dass die Wirkleistung $P_\mathrm{k}$ gegeben ist und sich folglich eliminiert. In der Nähe des Arbeitspunktes $v_\mathrm{k}$ folgt die Stromänderung aufgrund einer Blindleistungsinjektion
